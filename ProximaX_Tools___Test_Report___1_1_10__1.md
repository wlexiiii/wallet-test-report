...
-   [Services](#TestReport-1.1.10-1-Services)
    -   [Namespaces](#TestReport-1.1.10-1-Namespaces)
...
#### Register {#TestReport-1.1.10-1-Register style="margin-left: 30.0px;"}

#### Extend Duration {#TestReport-1.1.10-1-ExtendDuration style="margin-left: 30.0px;"}

### Assets {#TestReport-1.1.10-1-Assets}

#### Create {#TestReport-1.1.10-1-Create style="margin-left: 30.0px;"}

#### Modify Supply {#TestReport-1.1.10-1-ModifySupply style="margin-left: 30.0px;"}

#### Link to Namespaces {#TestReport-1.1.10-1-LinktoNamespaces style="margin-left: 30.0px;"}

### Swap {#TestReport-1.1.10-1-Swap}

#### NIS1 {#TestReport-1.1.10-1-NIS1 style="margin-left: 30.0px;"}

#### ETH {#TestReport-1.1.10-1-ETH style="margin-left: 30.0px;"}

#### BSC {#TestReport-1.1.10-1-BSC style="margin-left: 30.0px;"}

### Address Book {#TestReport-1.1.10-1-AddressBook}

#### List {#TestReport-1.1.10-1-List style="margin-left: 30.0px;"}

#### Add Contacts {#TestReport-1.1.10-1-AddContacts style="margin-left: 30.0px;"}

### Wallets {#TestReport-1.1.10-1-Wallets}

#### Change Password {#TestReport-1.1.10-1-ChangePassword style="margin-left: 30.0px;"}

#### Export {#TestReport-1.1.10-1-Export style="margin-left: 30.0px;"}

#### Delete {#TestReport-1.1.10-1-Delete style="margin-left: 30.0px;"}

### Voting {#TestReport-1.1.10-1-Voting}

#### Create Poll {#TestReport-1.1.10-1-CreatePoll style="margin-left: 30.0px;"}

#### Vote {#TestReport-1.1.10-1-Vote style="margin-left: 30.0px;"}

#### View Results {#TestReport-1.1.10-1-ViewResults style="margin-left: 30.0px;"}

### Storage {#TestReport-1.1.10-1-Storage}

#### Files {#TestReport-1.1.10-1-Files style="margin-left: 30.0px;"}

#### Upload File {#TestReport-1.1.10-1-UploadFile style="margin-left: 30.0px;"}

#### Send/Share {#TestReport-1.1.10-1-Send/Share style="margin-left: 30.0px;"}

### Sirius Gift {#TestReport-1.1.10-1-SiriusGift}

#### Create {#TestReport-1.1.10-1-Create.1 style="margin-left: 30.0px;"}

#### Redeem {#TestReport-1.1.10-1-Redeem style="margin-left: 30.0px;"}

### Aggregate Transactions {#TestReport-1.1.10-1-AggregateTransactions}

#### Complete {#TestReport-1.1.10-1-Complete style="margin-left: 30.0px;"}

#### Bonded {#TestReport-1.1.10-1-Bonded style="margin-left: 30.0px;"}
:::
...
[image-20220321-033506.png](attachments/2502098945/2502098959.png)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[image-20220321-013652.png](attachments/2502098945/2502098962.png)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[JuJFRQviEuNr-LFhKKtzgok1mpF5HDikOIL1_xWg6aGr2qkQ8QSbxpffBmBBZjHP0mp8bWeQOwXRWRwlDCdz6gs25qus8boYnGvW4GVGSyi0cdVFcdwMCJyRp_oVci2AbNXYamEotatFLomrkg](attachments/2502098945/2502098965)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[-bO8lWnCxvS5X986IxWgckBxaJCAbxhYl3-TF3royi6Q4j9TP6fotHOWiQ-il3_ryQNouMJ4csO5ZSgD_ZjKbkejc_edkj4PbVtm6f83nPyVS5LMbxvR1CSNaPwQrwZqw6pPpu1WRhThCx6m3A](attachments/2502098945/2502098968)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[b6Y7vdCjGYj4Iz0F_WS65i2cmIOlSUT86qa6i_8b-nI5nMCdfPd8pzyZ7F00oJUCaExJm6trTRKlkKGVJ7Sk77IHaRM8J3xiPRDc7QBvZKdGSgTdYDf5PENJN1AGkDy16cx3ElRHYzDKpmmMJA](attachments/2502098945/2502098971)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[IOJtLL0pqd1aniALXKyPdTwxaxYGSn3W1jljOpG7QSdSuVCpi_dPYNT7_TSWzywuHOToIQl_8CJ_Xcrub9PH6CVRPuiqvTt8-hr2133s6-CuwilYN9765uwm5vmiRFP8aSNp115F0eCwsraFrQ](attachments/2502098945/2502098974)
(image/png)\
:::
:::
:::
