...
-   [Services](#TestReport-1.2.1-1-Services)
    -   [Namespaces](#TestReport-1.2.1-1-Namespaces)
...
| ingSwap} |          |          |          |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        | Swap     | Click    | Main     | [PAS     |          |   |
| UTSWAP-1 |          | swap     | network  | S]{.stat |          |   |
|          |          | under    | swap     | us-macro |          |   |
|          |          | Quick    | page is  | .aui     |          |   |
|          |          | Action   | d        | -lozenge |          |   |
|          |          |          | isplayed | .aui-    |          |   |
...
+----------+----------+----------+----------+----------+----------+---+
| O        |          | Click    | Main     | [PAS     |          |   |
| UTSWAP-2 |          | swap on  | network  | S]{.stat |          |   |
|          |          | the      | swap     | us-macro |          |   |
|          |          | d        | page is  | .aui     |          |   |
|          |          | ashboard | d        | -lozenge |          |   |
|          |          |          | isplayed | .aui-    |          |   |
...
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        | Outgoing | Click    | Outgoing | [PAS     |          |   |
| UTSWAP-3 | swap     | dropdown | swap     | S]{.stat |          |   |
|          |          | list \>  | tra      | us-macro |          |   |
|          |          |          | nsaction | .aui     |          |   |
|          |          | select   | details  | -lozenge |          |   |
|          |          | sirius   | page is  | .aui-    |          |   |
|          |          | chain to | d        | lozenge- |          |   |
|          |          | bsc      | isplayed | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        | Select   | Click on | Displays | [PAS     |          |   |
| UTSWAP-4 | asset    | select   | asset    | S]{.stat |          |   |
|          |          | asset    | a        | us-macro |          |   |
|          |          | dropdown | vailable | .aui     |          |   |
|          |          | list     | for      | -lozenge |          |   |
|          |          |          | tra      | .aui-    |          |   |
|          |          |          | nsaction | lozenge- |          |   |
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        | Select   | Click on | A        | [PAS     |          |   |
| UTSWAP-5 | Account  | tra      | vailable | S]{.stat |          |   |
|          |          | nsaction | account  | us-macro |          |   |
|          |          | details  | dropdown | .aui     |          |   |
|          |          | dropdown | list     | -lozenge |          |   |
|          |          | list     | will     | .aui-    |          |   |
|          |          |          | show up, | lozenge- |          |   |
|          |          |          | user can | success} |          |   |
|          |          |          | select   |          |          |   |
...
|          |          |          | nsaction |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        | Transfer | Leave    | Prompt   | [PAS     |          |   |
| UTSWAP-6 | Amount   | transfer | error    | S]{.stat |          |   |
|          |          | amount   | message  | us-macro |          |   |
|          |          | as 0     | "Amount  | .aui     |          |   |
|          |          |          | is       | -lozenge |          |   |
|          |          |          | Empty"   | .aui-    |          |   |
|          |          |          |          | lozenge- |          |   |
...
+----------+----------+----------+----------+----------+----------+---+
| O        |          | Amount   | Prompt   | [PAS     |          |   |
| UTSWAP-7 |          | e        | error    | S]{.stat |          |   |
|          |          | xceeding | message  | us-macro |          |   |
|          |          | account  | "Insu    | .aui     |          |   |
|          |          | balance  | fficient | -lozenge |          |   |
|          |          |          | balance" | .aui-    |          |   |
|          |          |          |          | lozenge- |          |   |
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        |          | Account  | Prompt   | [PAS     |          |   |
| UTSWAP-8 |          | balance  | error    | S]{.stat |          |   |
|          |          | less     | message  | us-macro |          |   |
|          |          | than     | "Balance | .aui     |          |   |
|          |          | tra      | is       | -lozenge |          |   |
|          |          | nsaction | insu     | .aui-    |          |   |
|          |          | fee      | fficient | lozenge- |          |   |
|          |          |          | to cover | success} |          |   |
|          |          |          | tra      |          |          |   |
|          |          |          | nsaction |          |          |   |
|          |          |          | fee" and |          |          |   |
...
|          |          |          | disabled |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| O        | Metamask | Leave    | Shows a  | [PAS     |          |   |
| UTSWAP-9 | address  | metamask | error    | S]{.stat |          |   |
|          |          | address  | message  | us-macro |          |   |
|          |          | empty    | "Valid   | .aui     |          |   |
|          |          |          | BSC      | -lozenge |          |   |
|          |          |          | address  | .aui-    |          |   |
|          |          |          | is       | lozenge- |          |   |
...
|          |          |          | equired" |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       | Tra      | Select   | tra      | [PAS     |          |   |
| TSWAP-10 | nsaction | on       | nsaction | S]{.stat |          |   |
|          | fee      | tra      | fee type | us-macro |          |   |
|          |          | nsaction | will be  | .aui     |          |   |
|          |          | fee type | selected | -lozenge |          |   |
|          |          |          |          | .aui-    |          |   |
|          |          |          |          | lozenge- |          |   |
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       |          | Tra      | Tra      | [PAS     |          |   |
| TSWAP-11 |          | nsaction | nsaction | S]{.stat |          |   |
|          |          | fee      | fee will | us-macro |          |   |
|          |          | cal      | be       | .aui     |          |   |
|          |          | culation | ca       | -lozenge |          |   |
|          |          |          | lculated | .aui-    |          |   |
|          |          |          | directly | lozenge- |          |   |
...
|          |          |          | fee      |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       | Password | Leave    | Shows a  | [PAS     |          |   |
| TSWAP-12 |          | the      | error    | S]{.stat |          |   |
|          |          | password | message  | us-macro |          |   |
|          |          | field as | "        | .aui     |          |   |
|          |          | empty or | Password | -lozenge |          |   |
|          |          | less     | is       | .aui-    |          |   |
|          |          | than     | r        | lozenge- |          |   |
|          |          | required | equired" | success} |          |   |
|          |          | values   |          |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       | Outgoing | Enter    | Swap     | [PAS     |          |   |
| TSWAP-13 | swap     | valid    | tra      | S]{.stat |          |   |
|          | tra      | wallet   | nsaction | us-macro |          |   |
|          | nsaction | address, | will be  | .aui     |          |   |
|          | (xpx)    | valid    | succ     | -lozenge |          |   |
|          |          | transfer | essfully | .aui-    |          |   |
|          |          | amount   | created, | lozenge- |          |   |
|          |          | and      | noti     | success} |          |   |
|          |          | correct  | fication |          |          |   |
|          |          | wallet   | prompted |          |          |   |
|          |          | p        | and user |          |          |   |
...
+----------+----------+----------+----------+----------+----------+---+
| OU       |          | Enter    | Swap     | [PAS     |          |   |
| TSWAP-14 |          | valid    | tra      | S]{.stat |          |   |
|          |          | wallet   | nsaction | us-macro |          |   |
|          |          | address, | failed   | .aui     |          |   |
|          |          | valid    | with     | -lozenge |          |   |
|          |          | transfer | error    | .aui-    |          |   |
|          |          | amount   | message  | lozenge- |          |   |
|          |          | and      | shown    | success} |          |   |
|          |          | i        | "        |          |          |   |
|          |          | ncorrect | Password |          |          |   |
|          |          | wallet   | for      |          |          |   |
...
|          |          |          | invalid" |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       | Outgoing | Enter    | Swap     | [PAS     | While    |   |
| TSWAP-15 | swap     | valid    | tra      | S]{.stat | transfer |   |
|          | tra      | wallet   | nsaction | us-macro | can be   |   |
|          | nsaction | address, | will be  | .aui     | done,    |   |
|          | (metX)   | valid    | succ     | -lozenge | metx     |   |
|          |          | transfer | essfully | .aui-    | balance  |   |
|          |          | amount   | created, | lozenge- | amount   |   |
|          |          | and      | noti     | success} | shown on |   |
|          |          | correct  | fication |          | swap     |   |
|          |          | wallet   | prompted |          | page is  |   |
|          |          | p        | and user |          | 0, which |   |
|          |          | assword, | directed |          | is an    |   |
|          |          | click    | to       |          | error. [ |   |
|          |          | transfer | su       |          | [[]{.    |   |
|          |          |          | ccessful |          | aui-icon |   |
|          |          |          | swap     |          | .aui-i   |   |
...
+----------+----------+----------+----------+----------+----------+---+
| OU       |          | swap     | Swap     | [PAS     |          |   |
| TSWAP-17 |          | when     | tra      | S]{.stat |          |   |
|          |          | metx     | nsaction | us-macro |          |   |
|          |          | amount   | will be  | .aui     |          |   |
|          |          | is       | succ     | -lozenge |          |   |
|          |          | higher   | essfully | .aui-    |          |   |
|          |          | than xpx | created, | lozenge- |          |   |
|          |          | amount   | noti     | success} |          |   |
|          |          | in the   | fication |          |          |   |
|          |          | account  | prompted |          |          |   |
|          |          |          | and user |          |          |   |
...
|          |          |          | page     |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       | Cancel   | Click on | Swap     | [PAS     |          |   |
| TSWAP-18 |          | "Later"  | tra      | S]{.stat |          |   |
|          |          | icon     | nsaction | us-macro |          |   |
|          |          | button   | ca       | .aui     |          |   |
|          |          |          | ncelled, | -lozenge |          |   |
|          |          |          | user     | .aui-    |          |   |
|          |          |          | directed | lozenge- |          |   |
...
|          |          |          | page     |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| OU       | Eye icon | Click on | S        | [PAS     |          |   |
| TSWAP-19 |          | eye icon | how/hide | S]{.stat |          |   |
|          |          | button   | password | us-macro |          |   |
|          |          |          |          | .aui     |          |   |
|          |          |          |          | -lozenge |          |   |
|          |          |          |          | .aui-    |          |   |
|          |          |          |          | lozenge- |          |   |
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        | Cer      | Cick on  | Cer      | [PAS     |          |   |
| NSWAP-20 | tificate | cer      | tificate | S]{.stat |          |   |
|          |          | tificate | of the   | us-macro |          |   |
|          |          |          | swap     | .aui     |          |   |
|          |          |          | tra      | -lozenge |          |   |
|          |          |          | nsaction | .aui-    |          |   |
|          |          |          | is       | lozenge- |          |   |
...
|          |          |          | wnloaded |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        | Done     | Click on | User     | [PAS     |          |   |
| NSWAP-21 |          | Done     | directed | S]{.stat |          |   |
|          |          | after    | back to  | us-macro |          |   |
|          |          | checking | swap     | .aui     |          |   |
|          |          | on       | page     | -lozenge |          |   |
|          |          | checkbox |          | .aui-    |          |   |
|          |          | "I       |          | lozenge- |          |   |
...
|          |          | ificate" |          |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        |          | Click on | Unable   | [FAI     | [        |   |
| NSWAP-22 |          | Done     | to       | L]{.stat | [[]{.    |   |
|          |          | **w      | proceed  | us-macro | aui-icon |   |
|          |          | ithout** | to swap  | .aui     | .aui-i   |   |
|          |          | checking | page     | -lozenge | con-wait |   |
|          |          | on       |          | .au      | .i       |   |
|          |          | checkbox |          | i-lozeng | ssue-pla |   |
|          |          | "I       |          | e-error} | ceholder |   |
|          |          | confirm  |          |          | }WLT-86] |   |
|          |          | that I   |          |          | (https:/ |   |
|          |          | have     |          |          | /nemspfs |   |
...
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| INSWAP-2 |          | Click    | Main     | [PAS     |          |   |
|          |          | swap on  | network  | S]{.stat |          |   |
|          |          | the      | swap     | us-macro |          |   |
|          |          | d        | page is  | .aui     |          |   |
|          |          | ashboard | d        | -lozenge |          |   |
|          |          |          | isplayed | .aui-    |          |   |
...
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| INSWAP-3 | Incoming | Click    | Incoming | [PAS     |          |   |
|          | swap     | dropdown | swap     | S]{.stat |          |   |
|          |          | list \>  | tra      | us-macro |          |   |
|          |          |          | nsaction | .aui     |          |   |
|          |          | select   | details  | -lozenge |          |   |
|          |          | bsc to   | page is  | .aui-    |          |   |
|          |          | sirius   | d        | lozenge- |          |   |
|          |          | chain    | isplayed | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| INSWAP-4 | Select   | Click on | Displays | [PAS     |          |   |
|          | asset    | select   | asset    | S]{.stat |          |   |
|          |          | asset    | a        | us-macro |          |   |
|          |          | dropdown | vailable | .aui     |          |   |
|          |          | list     | for      | -lozenge |          |   |
|          |          |          | tra      | .aui-    |          |   |
...
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| INSWAP-5 | Select   | Click on | A        | [PAS     |          |   |
|          | Account  | tra      | vailable | S]{.stat |          |   |
|          |          | nsaction | account  | us-macro |          |   |
|          |          | details  | dropdown | .aui     |          |   |
|          |          | dropdown | list     | -lozenge |          |   |
|          |          | list     | will     | .aui-    |          |   |
...
|          |          |          | nsaction |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| INSWAP-6 | Transfer | Leave    | Prompt   | [PAS     |          |   |
|          | Amount   | transfer | error    | S]{.stat |          |   |
|          |          | amount   | message  | us-macro |          |   |
|          |          | as 0     | "Minimum | .aui     |          |   |
|          |          |          | amount   | -lozenge |          |   |
|          |          |          | is 51"   | .aui-    |          |   |
...
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| INSWAP-8 |          | Valid    | Error    | [PAS     |          |   |
|          |          | transfer | message  | S]{.stat |          |   |
|          |          | amount   | will     | us-macro |          |   |
|          |          |          | d        | .aui     |          |   |
|          |          |          | isappear | -lozenge |          |   |
|          |          |          | and      | .aui-    |          |   |
|          |          |          | "send    | lozenge- |          |   |
...
|          |          |          | enabled  |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        | Sirius   | Click on | Shows a  | [PAS     |          |   |
| NSWAP-10 | chain    | Sirius   | dropdown | S]{.stat |          |   |
|          | account  | chain    | list of  | us-macro |          |   |
|          |          | account  | a        | .aui     |          |   |
|          |          | dropdown | vailable | -lozenge |          |   |
|          |          | list     | account  | .aui-    |          |   |
|          |          |          | within   | lozenge- |          |   |
|          |          |          | the      | success} |          |   |
|          |          |          | wallet   |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        | Total    | Total    | Transfer | [PAS     |          |   |
| NSWAP-11 | transfer | transfer | amount   | S]{.stat |          |   |
|          | amount   | amount   | will be  | us-macro |          |   |
|          |          | shown    | shown    | .aui     |          |   |
|          |          |          | after    | -lozenge |          |   |
|          |          |          |          | .aui-    |          |   |
|          |          |          |          | lozenge- |          |   |
|          |          |          |          | success} |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        | Send     | Click on | Request  | [PAS     |          |   |
| NSWAP-12 | request  | send     | for      | S]{.stat |          |   |
|          |          | request  | token    | us-macro |          |   |
|          |          | button   | transfer | .aui     |          |   |
|          |          |          | to       | -lozenge |          |   |
|          |          |          | sirius   | .aui-    |          |   |
|          |          |          | will be  | lozenge- |          |   |
...
|          |          |          | address  |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        | Transfer | Click on | After    | [PAS     |          |   |
| NSWAP-13 | Va       | check    | getting  | S]{.stat |          |   |
|          | lidation | tra      | conf     | us-macro |          |   |
|          | (xpx)    | nsaction | irmation | .aui     |          |   |
|          |          | conf     | to       | -lozenge |          |   |
|          |          | irmation | proceed  | .aui-    |          |   |
|          |          | to       | from     | lozenge- |          |   |
...
|          |          |          | Metamask |          |          |   |
+----------+----------+----------+----------+----------+----------+---+
| I        |          | Click on | After    | [PAS     |          |   |
| NSWAP-14 |          | continue | getting  | S]{.stat |          |   |
|          |          |          | metamask | us-macro |          |   |
|          |          |          | account  | .aui     |          |   |
|          |          |          | s        | -lozenge |          |   |
|          |          |          | ignature | .aui-    |          |   |
...
+----------+----------+----------+----------+----------+----------+---+
| I        | Transfer | Click on | After    | [PAS     |          |   |
| NSWAP-15 | Va       | check    | getting  | S]{.stat |          |   |
|          | lidation | tra      | conf     | us-macro |          |   |
|          | (metx)   | nsaction | irmation | .aui     |          |   |
|          |          | conf     | to       | -lozenge |          |   |
|          |          | irmation | proceed  | .aui-    |          |   |
|          |          | to       | from     | lozenge- |          |   |
|          |          | proceed  | metamask | success} |          |   |
...
+----------+----------+----------+----------+----------+----------+---+
| I        |          | Click on | After    | [PAS     |          |   |
| NSWAP-16 |          | continue | getting  | S]{.stat |          |   |
|          |          |          | metamask | us-macro |          |   |
|          |          |          | account  | .aui     |          |   |
|          |          |          | s        | -lozenge |          |   |
|          |          |          | ignature | .aui-    |          |   |
...
+----------+----------+----------+----------+----------+----------+---+
| I        | Cer      | Cick on  | Cer      | [PAS     |          |   |
| NSWAP-17 | tificate | cer      | tificate | S]{.stat |          |   |
|          |          | tificate | of the   | us-macro |          |   |
|          |          |          | swap     | .aui     |          |   |
|          |          |          | tra      | -lozenge |          |   |
|          |          |          | nsaction | .aui-    |          |   |
...
#### Register {#TestReport-1.2.1-1-Register style="margin-left: 30.0px;"}

#### Extend Duration {#TestReport-1.2.1-1-ExtendDuration style="margin-left: 30.0px;"}

### Assets {#TestReport-1.2.1-1-Assets}

#### Create {#TestReport-1.2.1-1-Create style="margin-left: 30.0px;"}

#### Modify Supply {#TestReport-1.2.1-1-ModifySupply style="margin-left: 30.0px;"}

#### Link to Namespaces {#TestReport-1.2.1-1-LinktoNamespaces style="margin-left: 30.0px;"}

### Swap {#TestReport-1.2.1-1-Swap}

#### NIS1 {#TestReport-1.2.1-1-NIS1 style="margin-left: 30.0px;"}

#### ETH {#TestReport-1.2.1-1-ETH style="margin-left: 30.0px;"}

#### BSC {#TestReport-1.2.1-1-BSC style="margin-left: 30.0px;"}

### Address Book {#TestReport-1.2.1-1-AddressBook}

#### List {#TestReport-1.2.1-1-List style="margin-left: 30.0px;"}

#### Add Contacts {#TestReport-1.2.1-1-AddContacts style="margin-left: 30.0px;"}

### Wallets {#TestReport-1.2.1-1-Wallets}

#### Change Password {#TestReport-1.2.1-1-ChangePassword style="margin-left: 30.0px;"}

#### Export {#TestReport-1.2.1-1-Export style="margin-left: 30.0px;"}

#### Delete {#TestReport-1.2.1-1-Delete style="margin-left: 30.0px;"}

### Voting {#TestReport-1.2.1-1-Voting}

#### Create Poll {#TestReport-1.2.1-1-CreatePoll style="margin-left: 30.0px;"}

#### Vote {#TestReport-1.2.1-1-Vote style="margin-left: 30.0px;"}

#### View Results {#TestReport-1.2.1-1-ViewResults style="margin-left: 30.0px;"}

### Storage {#TestReport-1.2.1-1-Storage}

#### Files {#TestReport-1.2.1-1-Files style="margin-left: 30.0px;"}

#### Upload File {#TestReport-1.2.1-1-UploadFile style="margin-left: 30.0px;"}

#### Send/Share {#TestReport-1.2.1-1-Send/Share style="margin-left: 30.0px;"}

### Sirius Gift {#TestReport-1.2.1-1-SiriusGift}

#### Create {#TestReport-1.2.1-1-Create.1 style="margin-left: 30.0px;"}

#### Redeem {#TestReport-1.2.1-1-Redeem style="margin-left: 30.0px;"}

### Aggregate Transactions {#TestReport-1.2.1-1-AggregateTransactions}

#### Complete {#TestReport-1.2.1-1-Complete style="margin-left: 30.0px;"}

#### Bonded {#TestReport-1.2.1-1-Bonded style="margin-left: 30.0px;"}
:::
...
[IOJtLL0pqd1aniALXKyPdTwxaxYGSn3W1jljOpG7QSdSuVCpi_dPYNT7_TSWzywuHOToIQl_8CJ_Xcrub9PH6CVRPuiqvTt8-hr2133s6-CuwilYN9765uwm5vmiRFP8aSNp115F0eCwsraFrQ](attachments/2510553089/2510553103)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[b6Y7vdCjGYj4Iz0F_WS65i2cmIOlSUT86qa6i_8b-nI5nMCdfPd8pzyZ7F00oJUCaExJm6trTRKlkKGVJ7Sk77IHaRM8J3xiPRDc7QBvZKdGSgTdYDf5PENJN1AGkDy16cx3ElRHYzDKpmmMJA](attachments/2510553089/2510553106)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[-bO8lWnCxvS5X986IxWgckBxaJCAbxhYl3-TF3royi6Q4j9TP6fotHOWiQ-il3_ryQNouMJ4csO5ZSgD_ZjKbkejc_edkj4PbVtm6f83nPyVS5LMbxvR1CSNaPwQrwZqw6pPpu1WRhThCx6m3A](attachments/2510553089/2510553109)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[JuJFRQviEuNr-LFhKKtzgok1mpF5HDikOIL1_xWg6aGr2qkQ8QSbxpffBmBBZjHP0mp8bWeQOwXRWRwlDCdz6gs25qus8boYnGvW4GVGSyi0cdVFcdwMCJyRp_oVci2AbNXYamEotatFLomrkg](attachments/2510553089/2510553112)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[image-20220321-013652.png](attachments/2510553089/2510553115.png)
(image/png)\
![](images/icons/bullet_blue.gif){height="8" width="8"}
[image-20220321-033506.png](attachments/2510553089/2510553118.png)
(image/png)\
:::
:::
:::
